...
It's based on [Paradise Station](https://github.com/ParadiseSS13/Paradise) and [Goon Station](https://github.com/goonstation/goonstation-2016) - This Code is a Modification of a Brazilian code, now i'am tryng to make a total conversion of the game.
...
When that opens, type in:
    ...
    git clone https://github.com/Cachorro112/2020---Space-Station-13/
